...
if __name__ == "__main__":
  ...
  comp.competitor("post_collection_facets", args.lucene_dir, index=index, searchConcurrency=args.cpuNum, numConcurrentQueries=args.cpuNum, cpus=args.cpuNum, testContext="facetMode:POST_COLLECTION", pk=False)
  comp.competitor("during_collection_facets", args.lucene_dir, index=index, searchConcurrency=args.cpuNum, numConcurrentQueries=args.cpuNum, cpus=args.cpuNum, testContext="facetMode:DURING_COLLECTION", pk=False)
